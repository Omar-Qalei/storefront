/*! vue-grid-layout - 2.3.12 | (c) 2015, 2021  [object Object] | https://github.com/jbaysolutions/vue-grid-layout */
...
// CONCATENATED MODULE: ./src/components/GridLayout.vue?vue&type=template&id=fabccb68&
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      this.$nextTick(function () {
        ...
        Object(utils["c" /* compact */])(self.layout, self.verticalCompact, self.allowCollides);
  ...
  methods: {
    layoutUpdate: function layoutUpdate() {
      if (this.layout !== undefined && this.originalLayout !== null) {
        ...
        Object(utils["c" /* compact */])(this.layout, this.verticalCompact, this.allowCollides);
        this.eventBus.$emit("updateWidth", this.width);
        this.updateHeight();
    ...
    containerHeight: function containerHeight() {
      ...
      var containerHeight = Object(utils["a" /* bottom */])(this.layout) * (this.rowHeight + this.margin[1]) + this.margin[1] + "px"; // For calculate by number of rows rather than pixels

      this.$emit("layoutHeight", this.calcContainerHeightByRow(Object(utils["a" /* bottom */])(this.layout) * (this.rowHeight + this.margin[1]) + this.margin[0]));
    ...
    containerHeightPlacerholder: function containerHeightPlacerholder() {
      ...
      return this.minH ? this.minH - calcMargin : Object(utils["a" /* bottom */])(this.layout);
    },
    dragEvent: function dragEvent(eventName, id, x, y, h, w) {
      ...
      Object(utils["c" /* compact */])(this.layout, this.verticalCompact, this.allowCollides); // needed because vue can't detect changes on array element properties
...
// module
exports.push([module.i, ".vue-grid-item{-webkit-transition:all .2s ease;transition:all .2s ease;-webkit-transition-property:left,top,right;transition-property:left,top,right}.vue-grid-item.no-touch{-ms-touch-action:none;touch-action:none}.vue-grid-item.cssTransforms{-webkit-transition-property:-webkit-transform;transition-property:-webkit-transform;transition-property:transform;transition-property:transform,-webkit-transform;left:0;right:auto}.vue-grid-item.cssTransforms.render-rtl{left:auto;right:0}.vue-grid-item.resizing{opacity:.6;z-index:3}.vue-grid-item.vue-draggable-dragging{-webkit-transition:none;transition:none;z-index:3}.vue-grid-item.vue-grid-placeholder{border:.5px solid #6d6e6e;opacity:.2;-webkit-transition-duration:.1s;transition-duration:.1s;z-index:2;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;-o-user-select:none;user-select:none}.vue-grid-item>.vue-resizable-handle{position:absolute;width:20px;height:20px;bottom:0;right:0;background:url(\"data:image/svg+xml;base64,PHN2ZyBzdHlsZT0iYmFja2dyb3VuZC1jb2xvcjojZmZmZmZmMDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgd2lkdGg9IjYiIGhlaWdodD0iNiI+PHBhdGggZD0iTTYgNkgwVjQuMmg0LjJWMEg2djZ6IiBvcGFjaXR5PSIuMzAyIi8+PC9zdmc+\");background-position:100% 100%;padding:0 3px 3px 0;background-repeat:no-repeat;background-origin:content-box;-webkit-box-sizing:border-box;box-sizing:border-box;cursor:se-resize}.vue-grid-item>.vue-rtl-resizable-handle{bottom:0;left:0;background:url(data:image/svg+xml;base64,);background-position:0 100%;padding-left:3px;background-repeat:no-repeat;background-origin:content-box;cursor:sw-resize;right:auto}.vue-grid-item.disable-userselect{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}", ""]);
...
"use strict";
/* unused harmony export statusCollides */
...
var statusCollides = true; // export type Position = {left: number, top: number, width: number, height: number};
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"5946bc39-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridItem.vue?vue&type=template&id=a6e11292&
...
// CONCATENATED MODULE: ./src/components/GridItem.vue?vue&type=template&id=a6e11292&
