<template>
  <v-container class="map-design" fluid>
    <v-row class="pt-4">
      <v-col cols="12">
      ...
      <v-col align-self="center" cols="9">
        <h2 class="body-1 font-weight-medium">
          Map Border Radius Bottom Right
        </h2>
      </v-col>
      <v-col cols="2">
        <v-text-field
