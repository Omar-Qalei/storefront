  ...
  data() {
    return {
      ...
      tags: [
        ...
        { id: 1, title: "Active color", value: "hover" },
      ],
    };
  },
  computed: {
  ...
  created() {
    if (this.getSelectedWidgetById.properties.style) {
      if (this.getSelectedWidgetById.properties.style.elements) {
        if (this.getSelectedWidgetById.properties.style.elements.text) {
          this.selectedTextHorizontal = this.findIndex(
            { list: this.textHorizontal, value: "title" },
            this.getSelectedWidgetById.properties.style.elements.text.textAlign
          );
          this.selectedFontSize = this.findIndex(
            { list: this.fontSizes, value: "value" },
            this.getSelectedWidgetById.properties.style.elements.text.fontSize
          );
          this.textColor = this.getSelectedWidgetById.properties.style.elements.text.color;
          ...
          this.letterCase = this.findIndex(
            ...
            this.getSelectedWidgetById.properties.style.elements.text
              .textTransform
          );
