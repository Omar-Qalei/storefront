        ...
        <v-card-text>
          <v-row class="my-4" align="center">
            ...
            <v-btn outlined color="primary" @click="addDialog = true">
              <v-icon>mdi-plus</v-icon> Campaigns
            </v-btn>
          </v-row>
        </v-card-text>
      </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      contactId: null,
      headers: [
        { text: "Status", value: "first_name" },
        { text: "Campaign Name", value: "last_name" },
        { text: "Delivered", value: "email" },
        { text: "Unique Opens", value: "job_title" },
        { text: "Unique clicks", value: "mobile" },
        { text: "Unsubscribes", value: "address" },
        { text: "", value: "actions" },
      ],
      desserts: [],
    };
